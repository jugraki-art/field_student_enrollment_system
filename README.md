...
1. Requirement Analysis
   Project Execution Activities: Interviews with the Training Officer to establish required enrollment fields and business validation rules.
   Key Artifacts: Software Requirement Specification (SRS)

2. System Design
   Project Execution Activities:Designing responsive UI wireframes, JavaScript logical workflows, and database schema (`field_students` table).
   Key Artifacts: Data Dictionary & UI Layouts

3. Implementation
   Project Execution Activities: Writing clean client-side logic (HTML/CSS/JS) with browser `localStorage` and PHP backend API endpoints.
   Key Artifacts: Source Code Package

4. Testing
 Project Execution Activities: Executing unit tests on input fields, boundary testing on start/end dates, and User Acceptance Testing (UAT).
   Key Artifacts: Test Case Log

5. Deployment
       Project Execution Activities:
                  >Deploying static web assets locally and
                  >configuring XAMPP for LAN multi-PC access across HQ workstations.
      Key Artifacts: User Guide & Handover
...
ID Test Scenario Input Data Expected Result Status
  1.TC-01 Valid Enrollment
   Start: 2026-08-01, End: 2026-10-01 Record added, Status = Active PASS
  2.TC-02 Invalid Date
    Sequence
    Start: 2026-08-10, End: 2026-08-01
    Alert: "Ending day must be after Starting day" PASS
 3.TC-03 Expired Field Period
    Start: 2026-05-01, End: 2026-07-01 Record added, Status = Completed PASS
